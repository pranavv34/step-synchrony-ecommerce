...
<section class="category">
   ...
   <a href="category.php?category=Skechers" class="swiper-slide slide">
   ...
   <a href="category.php?category=Redtape" class="swiper-slide slide">
   ...
   <a href="category.php?category=NewBalance" class="swiper-slide slide">
...
<section class="home-products">
   ...
   <form action="" method="post" class="swiper-slide slide">
      ...
      <input type="submit" value="add to cart" class="btn1" name="add_to_cart">
   </form>
   <?php
      }
   }else{
...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img class="d-block w-100" src="images/banner-1.png" alt="First slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/banner-2.png" alt="Second slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/banner-3.png" alt="Third slide">
    </div>
    <div class="carousel-item">
      <img class="d-block w-100" src="images/banner-4.png" alt="Fourth slide">
    </div>
  </div>
